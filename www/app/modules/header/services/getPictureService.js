'use strict';
headerModule.service('getPictureService', ['serviceFactory', '$http', '$log', '$q', '$state', '$rootScope', function(serviceFactory, $http, $log, $q, $state, $rootScope) {

    this.serverUrl = "getPicture";
    this.httpurl = null;

    this.responseData = null;

    this.getPictureRequest = function(data) {
